...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x8000002Fu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x02300000u);
		...
		CY_SET_REG32((void *)(CYREG_CPUSS_INTR_SELECT), 0x00000006u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x005B6DB6u);
	CY_SET_REG32((void *)(CYREG_PRT0_INTCFG), 0x00008000u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x00000014u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC2), 0x00000014u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x00000007u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC2), 0x00000007u);
