// ======================================================================
// prueba Generador Onda Cuadrada.v generated from TopDesign.cysch
// 12/20/2020 at 11:41
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=50, CompareValue2=128, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=true, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=1, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=100, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM, CY_INSTANCE_SHORT_NAME=PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM, )
module PWM_v3_30_2 (
    capture,
    clock,
    cmp_sel,
...
module top ;
	...
	wire [0:0] tmpOE__SW1_Vout_net;
	wire [0:0] tmpFB_0__SW1_Vout_net;
	wire [0:0] tmpIO_0__SW1_Vout_net;
	electrical [0:0] tmpSIOVREF__SW1_Vout_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		SW1_Vout
		 (.oe(tmpOE__SW1_Vout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW1_Vout_net[0:0]}),
		  .io({tmpIO_0__SW1_Vout_net[0:0]}),
		  .siovref(tmpSIOVREF__SW1_Vout_net),
		  .interrupt({Net_11}),
		  .annotation({Net_12}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SW1_Vout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Nivel_Vout_net;
	wire [0:0] tmpFB_0__Nivel_Vout_net;
	wire [0:0] tmpIO_0__Nivel_Vout_net;
	wire [0:0] tmpINTERRUPT_0__Nivel_Vout_net;
	electrical [0:0] tmpSIOVREF__Nivel_Vout_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("aa434332-d366-4452-8400-a323cf66e904"),
		  ...
		  .input_buffer_sel(2'b00))
		Nivel_Vout
		 (.oe(tmpOE__Nivel_Vout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Nivel_Vout_net[0:0]}),
		  .analog({Net_288}),
		  .io({tmpIO_0__Nivel_Vout_net[0:0]}),
		  .siovref(tmpSIOVREF__Nivel_Vout_net),
		  .interrupt({tmpINTERRUPT_0__Nivel_Vout_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Nivel_Vout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCD_v2_20_1 LCD ();

	wire [0:0] tmpOE__DutyC_Vout_net;
	wire [0:0] tmpFB_0__DutyC_Vout_net;
	wire [0:0] tmpIO_0__DutyC_Vout_net;
	wire [0:0] tmpINTERRUPT_0__DutyC_Vout_net;
	electrical [0:0] tmpSIOVREF__DutyC_Vout_net;

	cy_psoc3_pins_v1_10
		#(.id("0375584c-3b15-4b04-be14-c7b43d6cf796"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DutyC_Vout
		 (.oe(tmpOE__DutyC_Vout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DutyC_Vout_net[0:0]}),
		  .analog({Net_268}),
		  .io({tmpIO_0__DutyC_Vout_net[0:0]}),
		  .siovref(tmpSIOVREF__DutyC_Vout_net),
		  .interrupt({tmpINTERRUPT_0__DutyC_Vout_net[0:0]}),
		  .annotation({Net_272}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__DutyC_Vout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PERIODO_Vout_net;
	wire [0:0] tmpFB_0__PERIODO_Vout_net;
	wire [0:0] tmpIO_0__PERIODO_Vout_net;
	wire [0:0] tmpINTERRUPT_0__PERIODO_Vout_net;
	electrical [0:0] tmpSIOVREF__PERIODO_Vout_net;

	cy_psoc3_pins_v1_10
		#(.id("07c54a5c-cb9e-4773-bdaf-fc53e7ae2ae3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PERIODO_Vout
		 (.oe(tmpOE__PERIODO_Vout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PERIODO_Vout_net[0:0]}),
		  .analog({Net_270}),
		  .io({tmpIO_0__PERIODO_Vout_net[0:0]}),
		  .siovref(tmpSIOVREF__PERIODO_Vout_net),
		  .interrupt({tmpINTERRUPT_0__PERIODO_Vout_net[0:0]}),
		  .annotation({Net_271}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PERIODO_Vout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("ef4a263a-5bcb-447d-bfcf-8a2510b81b85"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
