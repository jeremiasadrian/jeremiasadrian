// ======================================================================
// prueba Control IDAC+ADC.v generated from TopDesign.cysch
// 12/19/2020 at 08:15
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f1359b2c-7c6a-48eb-ac9c-0dc6f90e0613/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Iout_neg_net;
	wire [0:0] tmpFB_0__Iout_neg_net;
	wire [0:0] tmpIO_0__Iout_neg_net;
	wire [0:0] tmpINTERRUPT_0__Iout_neg_net;
	electrical [0:0] tmpSIOVREF__Iout_neg_net;
	...
	cy_psoc3_pins_v1_10
		...
		Iout_neg
		 (.oe(tmpOE__Iout_neg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Iout_neg_net[0:0]}),
		  .analog({Net_32}),
		  .io({tmpIO_0__Iout_neg_net[0:0]}),
		  .siovref(tmpSIOVREF__Iout_neg_net),
		  .interrupt({tmpINTERRUPT_0__Iout_neg_net[0:0]}),
		  .annotation({Net_50}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Iout_neg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SW1_AMux_net;
	wire [0:0] tmpFB_0__SW1_AMux_net;
	wire [0:0] tmpIO_0__SW1_AMux_net;
	electrical [0:0] tmpSIOVREF__SW1_AMux_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		SW1_AMux
		 (.oe(tmpOE__SW1_AMux_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW1_AMux_net[0:0]}),
		  .io({tmpIO_0__SW1_AMux_net[0:0]}),
		  .siovref(tmpSIOVREF__SW1_AMux_net),
		  .interrupt({Net_11}),
		  .annotation({Net_12}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SW1_AMux_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Iout_pos_net;
	wire [0:0] tmpFB_0__Iout_pos_net;
	wire [0:0] tmpIO_0__Iout_pos_net;
	wire [0:0] tmpINTERRUPT_0__Iout_pos_net;
	electrical [0:0] tmpSIOVREF__Iout_pos_net;

	cy_psoc3_pins_v1_10
		#(.id("e83980a8-24a2-4280-95ed-dd6dd2a8ed28"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Iout_pos
		 (.oe(tmpOE__Iout_pos_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Iout_pos_net[0:0]}),
		  .analog({Net_34}),
		  .io({tmpIO_0__Iout_pos_net[0:0]}),
		  .siovref(tmpSIOVREF__Iout_pos_net),
		  .interrupt({tmpINTERRUPT_0__Iout_pos_net[0:0]}),
		  .annotation({Net_58}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Iout_pos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam R_2.comp_name = "Potentiometer_v1_0";
    defparam R_2.port_names = "T1, T2, W";
    defparam R_2.width = 3;
	...
	wire [0:0] tmpOE__conIDAC_net;
	wire [0:0] tmpFB_0__conIDAC_net;
	wire [0:0] tmpIO_0__conIDAC_net;
	wire [0:0] tmpINTERRUPT_0__conIDAC_net;
	electrical [0:0] tmpSIOVREF__conIDAC_net;

	cy_psoc3_pins_v1_10
		#(.id("aa434332-d366-4452-8400-a323cf66e904"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		conIDAC
		 (.oe(tmpOE__conIDAC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__conIDAC_net[0:0]}),
		  .analog({Net_199}),
		  .io({tmpIO_0__conIDAC_net[0:0]}),
		  .siovref(tmpSIOVREF__conIDAC_net),
		  .interrupt({tmpINTERRUPT_0__conIDAC_net[0:0]}),
		  .annotation({Net_198}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__conIDAC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
