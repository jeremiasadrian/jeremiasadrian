...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x8000006Au);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x31100000u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x000000D7u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x00580000u);
	CY_SET_REG32((void *)(CYREG_PRT1_INTCFG), 0x00008000u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC2), 0x00000017u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x00000001u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00000002u);
	CY_SET_REG32((void *)(CYREG_PRT2_INTCFG), 0x00000002u);

	/* IOPINS0_3 Starting address: CYDEV_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT3_BASE), 0x00000081u);
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x00C00002u);
	CY_SET_REG32((void *)(CYREG_PRT3_INTCFG), 0x00000002u);
