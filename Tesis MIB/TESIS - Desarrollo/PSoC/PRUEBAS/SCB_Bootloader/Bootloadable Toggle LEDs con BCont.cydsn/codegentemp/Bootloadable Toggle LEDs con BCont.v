// ======================================================================
// Bootloadable Toggle LEDs con BCont.v generated from TopDesign.cysch
// 11/17/2020 at 15:24
...
module top ;
	...
	wire [0:0] tmpOE__PinEXT2_net;
	wire [0:0] tmpFB_0__PinEXT2_net;
	wire [0:0] tmpIO_0__PinEXT2_net;
	wire [0:0] tmpINTERRUPT_0__PinEXT2_net;
	electrical [0:0] tmpSIOVREF__PinEXT2_net;

	cy_psoc3_pins_v1_10
		#(.id("212891f5-1513-4e81-8490-d8a697092b5e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PinEXT2
		 (.oe(tmpOE__PinEXT2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinEXT2_net[0:0]}),
		  .io({tmpIO_0__PinEXT2_net[0:0]}),
		  .siovref(tmpSIOVREF__PinEXT2_net),
		  .interrupt({tmpINTERRUPT_0__PinEXT2_net[0:0]}),
		  .annotation({Net_67}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PinEXT2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
