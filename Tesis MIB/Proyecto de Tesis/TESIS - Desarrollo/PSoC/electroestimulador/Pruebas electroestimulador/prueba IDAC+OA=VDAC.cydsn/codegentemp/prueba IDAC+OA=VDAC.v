// ======================================================================
// prueba IDAC+OA=VDAC.v generated from TopDesign.cysch
// 12/19/2020 at 08:18
...
module top ;
	...
	wire [0:0] tmpOE__SW1_IDAC_net;
	wire [0:0] tmpFB_0__SW1_IDAC_net;
	wire [0:0] tmpIO_0__SW1_IDAC_net;
	electrical [0:0] tmpSIOVREF__SW1_IDAC_net;
	...
	cy_psoc3_pins_v1_10
		...
		SW1_IDAC
		 (.oe(tmpOE__SW1_IDAC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW1_IDAC_net[0:0]}),
		  .io({tmpIO_0__SW1_IDAC_net[0:0]}),
		  .siovref(tmpSIOVREF__SW1_IDAC_net),
		  .interrupt({Net_11}),
		  .annotation({Net_12}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SW1_IDAC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
