// ======================================================================
// prueba VDAC_relevamientoTester.v generated from TopDesign.cysch
// 12/19/2020 at 08:15
...
module top ;
	...
	wire [0:0] tmpOE__SW1_RAMPA_net;
	wire [0:0] tmpFB_0__SW1_RAMPA_net;
	wire [0:0] tmpIO_0__SW1_RAMPA_net;
	electrical [0:0] tmpSIOVREF__SW1_RAMPA_net;
	...
	cy_psoc3_pins_v1_10
		...
		SW1_RAMPA
		 (.oe(tmpOE__SW1_RAMPA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW1_RAMPA_net[0:0]}),
		  .io({tmpIO_0__SW1_RAMPA_net[0:0]}),
		  .siovref(tmpSIOVREF__SW1_RAMPA_net),
		  .interrupt({Net_11}),
		  .annotation({Net_12}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SW1_RAMPA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("f151dba3-c986-4c04-be72-789867fe9d2c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Vpos_net;
	wire [0:0] tmpFB_0__Vpos_net;
	wire [0:0] tmpIO_0__Vpos_net;
	wire [0:0] tmpINTERRUPT_0__Vpos_net;
	electrical [0:0] tmpSIOVREF__Vpos_net;

	cy_psoc3_pins_v1_10
		#(.id("0699853b-f360-4a76-8130-3f6ecbb7e58d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Vpos
		 (.oe(tmpOE__Vpos_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vpos_net[0:0]}),
		  .analog({Net_17}),
		  .io({tmpIO_0__Vpos_net[0:0]}),
		  .siovref(tmpSIOVREF__Vpos_net),
		  .interrupt({tmpINTERRUPT_0__Vpos_net[0:0]}),
		  .annotation({Net_29}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Vpos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Vinv_net;
	wire [0:0] tmpFB_0__Vinv_net;
	wire [0:0] tmpIO_0__Vinv_net;
	wire [0:0] tmpINTERRUPT_0__Vinv_net;
	electrical [0:0] tmpSIOVREF__Vinv_net;

	cy_psoc3_pins_v1_10
		#(.id("aa706ea1-9707-4594-b4dd-a21c007c958a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Vinv
		 (.oe(tmpOE__Vinv_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vinv_net[0:0]}),
		  .analog({Net_23}),
		  .io({tmpIO_0__Vinv_net[0:0]}),
		  .siovref(tmpSIOVREF__Vinv_net),
		  .interrupt({tmpINTERRUPT_0__Vinv_net[0:0]}),
		  .annotation({Net_33}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Vinv_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
