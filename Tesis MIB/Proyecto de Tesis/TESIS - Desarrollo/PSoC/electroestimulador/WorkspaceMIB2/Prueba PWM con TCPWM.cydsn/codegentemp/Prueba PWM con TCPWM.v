// ======================================================================
// Prueba PWM con TCPWM.v generated from TopDesign.cysch
// 12/21/2020 at 18:37
...
module top ;
	...
	wire [0:0] tmpOE__PWM_POS_net;
	wire [0:0] tmpFB_0__PWM_POS_net;
	wire [0:0] tmpIO_0__PWM_POS_net;
	wire [0:0] tmpINTERRUPT_0__PWM_POS_net;
	electrical [0:0] tmpSIOVREF__PWM_POS_net;
	...
	cy_psoc3_pins_v1_10
		...
		PWM_POS
		 (.oe(tmpOE__PWM_POS_net),
		  .y({Net_6}),
		  .fb({tmpFB_0__PWM_POS_net[0:0]}),
		  .io({tmpIO_0__PWM_POS_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_POS_net),
		  .interrupt({tmpINTERRUPT_0__PWM_POS_net[0:0]}),
		  .annotation({Net_26}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PWM_POS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PWM_NEG_net;
	wire [0:0] tmpFB_0__PWM_NEG_net;
	wire [0:0] tmpIO_0__PWM_NEG_net;
	wire [0:0] tmpINTERRUPT_0__PWM_NEG_net;
	electrical [0:0] tmpSIOVREF__PWM_NEG_net;

	cy_psoc3_pins_v1_10
		#(.id("5da68340-a6eb-4494-8ab7-456e56b00856"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_NEG
		 (.oe(tmpOE__PWM_NEG_net),
		  .y({Net_7}),
		  .fb({tmpFB_0__PWM_NEG_net[0:0]}),
		  .io({tmpIO_0__PWM_NEG_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_NEG_net),
		  .interrupt({tmpINTERRUPT_0__PWM_NEG_net[0:0]}),
		  .annotation({Net_28}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PWM_NEG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_INT_CC_net;
	wire [0:0] tmpFB_0__Pin_INT_CC_net;
	wire [0:0] tmpIO_0__Pin_INT_CC_net;
	wire [0:0] tmpINTERRUPT_0__Pin_INT_CC_net;
	electrical [0:0] tmpSIOVREF__Pin_INT_CC_net;

	cy_psoc3_pins_v1_10
		#(.id("1dd32d79-acc4-4b6c-b9dc-6fcaa79d314b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_INT_CC
		 (.oe(tmpOE__Pin_INT_CC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_INT_CC_net[0:0]}),
		  .io({tmpIO_0__Pin_INT_CC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_INT_CC_net),
		  .interrupt({tmpINTERRUPT_0__Pin_INT_CC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_INT_CC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_INT_TC_net;
	wire [0:0] tmpFB_0__Pin_INT_TC_net;
	wire [0:0] tmpIO_0__Pin_INT_TC_net;
	wire [0:0] tmpINTERRUPT_0__Pin_INT_TC_net;
	electrical [0:0] tmpSIOVREF__Pin_INT_TC_net;

	cy_psoc3_pins_v1_10
		#(.id("53a4a970-7a80-4b1f-a855-0d519732c27c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_INT_TC
		 (.oe(tmpOE__Pin_INT_TC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_INT_TC_net[0:0]}),
		  .io({tmpIO_0__Pin_INT_TC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_INT_TC_net),
		  .interrupt({tmpINTERRUPT_0__Pin_INT_TC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_INT_TC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
