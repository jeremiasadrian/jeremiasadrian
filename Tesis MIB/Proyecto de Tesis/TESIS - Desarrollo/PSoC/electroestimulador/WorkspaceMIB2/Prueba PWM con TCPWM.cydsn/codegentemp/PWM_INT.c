...
{
    #ifdef PWM_INT_INTERRUPT_INTERRUPT_CALLBACK
        PWM_INT_Interrupt_InterruptCallback();
    #endif /* PWM_INT_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling PWM_INT_Start or PWM_INT_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after PWM_INT_Start or PWM_INT_StartEx has been called. 
