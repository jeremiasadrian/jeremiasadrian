// ======================================================================
// Bootloadable Toggle LEDs por HW.v generated from TopDesign.cysch
// 11/17/2020 at 14:18
...
module top ;
	...
	wire [0:0] tmpOE__PinEXT_net;
	wire [0:0] tmpFB_0__PinEXT_net;
	wire [0:0] tmpIO_0__PinEXT_net;
	wire [0:0] tmpINTERRUPT_0__PinEXT_net;
	electrical [0:0] tmpSIOVREF__PinEXT_net;
	...
	cy_psoc3_pins_v1_10
		...
		PinEXT
		 (.oe(tmpOE__PinEXT_net),
		  .y({Net_48}),
		  .fb({tmpFB_0__PinEXT_net[0:0]}),
		  .io({tmpIO_0__PinEXT_net[0:0]}),
		  .siovref(tmpSIOVREF__PinEXT_net),
		  .interrupt({tmpINTERRUPT_0__PinEXT_net[0:0]}),
		  .annotation({Net_81}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PinEXT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PinONB_net;
	wire [0:0] tmpFB_0__PinONB_net;
	wire [0:0] tmpIO_0__PinONB_net;
	wire [0:0] tmpINTERRUPT_0__PinONB_net;
	electrical [0:0] tmpSIOVREF__PinONB_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PinONB
		 (.oe(tmpOE__PinONB_net),
		  .y({Net_54[1]}),
		  .fb({tmpFB_0__PinONB_net[0:0]}),
		  .io({tmpIO_0__PinONB_net[0:0]}),
		  .siovref(tmpSIOVREF__PinONB_net),
		  .interrupt({tmpINTERRUPT_0__PinONB_net[0:0]}),
		  .annotation({Net_38}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PinONB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- TFF Start --
    reg [1:0] cy_tff_1;
    always @(posedge Net_43)
    begin
        cy_tff_1 <= Net_42[1:0]^Net_54[1:0];
    end
    assign Net_54[1:0] = cy_tff_1;
    // -- TFF End --

    assign Net_42[1] = 1'h1;


    assign Net_48 = ~Net_54[0];
